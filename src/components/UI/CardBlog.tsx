  ...
  return (
    <Card>
      <CardActionArea className="p-2">
        ...
        <CardContent>
          <Chip
            className="mb-4 rounded-md bg-[#E0E6F6] text-[#3C65F5]"
            label="News"
          />
          ...
          <div className="flex items-center justify-between">
            <div className="mt-3 flex h-full items-center justify-start gap-2">
              <Avatar
              ...
              <div className="flex flex-col items-start">
                ...
                <p className="text-xs leading-none">06 September</p>
              </div>
            </div>
